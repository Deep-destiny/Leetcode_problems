...
//         // step1: replacement according to query and find remainder according according to x in the query
//         n= queries.length;
...
//         return res;
//     }
//     private void xvalue(int[] nums,int[] res){
//         long [] prevcount=0;
//         for(int i=0;i<n;i++){
//             long[] currcoutn= new long[k];
